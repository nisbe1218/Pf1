...
\foreach \uc in {auth,crud,predict,export,analytics,monitor,import,preproc,valid,users}
...
% Professor → clinical use cases + import/preprocess (NO validate, NO users)
...
\end{tikzpicture}}
\caption{Use Case Diagram — AI NéphroCare (4 actors, 10 use cases). Professor and Resident have identical access. Validate \& Integrate Import is restricted to Super Admin and Head of Department.}
\label{fig:use_case}
\end{figure}
