...
\texttt{ferritine\_basale} & SHAP top-24 &
  Ferritin $<$200 or $>$800~ng/mL both signal suboptimal anaemia management; ESA hypo-response linked to higher mortality in HD &
  \cite{kdigo_anemia_2012} \\[4pt]
...
\texttt{maladie\_renale\_hereditaire} & Lit. &
  ADPKD and hereditary nephropathies have slower cardiovascular mortality than diabetic CKD but specific complications (cyst haemorrhage, pain); phenotypic flag essential for risk stratification &
  \cite{grantham2008adpkd, kdigo2015} \\[4pt]

\texttt{hemodialyse} & Lit. &
  Dialysis modality (HD vs.\ PD) impacts solute clearance and cardiovascular load; DOPPS shows that treatment time and session parameters directly determine mortality risk in HD patients &
  \cite{kdigo2015, saran2006dopps} \\[4pt]
