...
\texttt{seances\_par\_semaine} & SHAP top-24 &
  Fewer than 3 sessions/week is associated with increased mortality in worldwide DOPPS data; dialysis frequency is a primary adequacy determinant &
  \cite{dopps2022} \\[4pt]

\texttt{etiologie\_mrc} & SHAP top-24 &
  CKD aetiology (diabetic nephropathy, hypertensive, hereditary) determines complication profile, residual function trajectory and long-term survival &
  \cite{kdigo2015, brenner_kidney_2020} \\[4pt]

\texttt{annee\_inclusion} & SHAP top-24 &
  Temporal covariate: patients included later (2022--2024) benefit from improved protocols; DOPPS shows measurable practice-era effects on survival &
  \cite{dopps2022} \\[4pt]
...
\texttt{douleur\_abdominale} & Lit. &
  GI complications (ulcers, mesenteric ischaemia, liver disease) are included in the Charlson Comorbidity Index and are documented mortality predictors in HD cohorts &
  \cite{beddhu2000charlson, dopps2022} \\[4pt]
...
\texttt{maladie\_renale\_hereditaire} & Lit. &
  ADPKD and other hereditary nephropathies have a distinct complication profile with lower cardiovascular mortality but higher risk of rupture and haemorrhagic complications &
  \cite{kdigo2015, brenner_kidney_2020} \\[4pt]

\texttt{hemodialyse} & Lit. &
  Dialysis modality (HD vs.\ PD) significantly impacts solute clearance, cardiovascular load, and infection risk; modality is a primary KDIGO prognostic variable &
  \cite{kdigo2015, dopps2022} \\[4pt]
