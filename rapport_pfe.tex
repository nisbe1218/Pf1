...
\texttt{nombre\_hospitalisations} & SHAP top-24 &
  Hospitalisation count captures cumulative clinical burden; the Charlson comorbidity scale — which integrates hospitalisable conditions — independently predicts mortality and costs in dialysis patients &
...
\texttt{maladie\_renale\_hereditaire} & Lit. &
  Polycystic kidney disease is an explicit etiology feature in the Sheng 2020 1-year HD mortality model; ADPKD has a distinct complication profile and lower cardiovascular mortality than diabetic CKD &
  \cite{grantham2008adpkd, sheng2020} \\[4pt]
