...
\texttt{fistule\_arterioveineuse\allowbreak\_creee} & SHAP \#1 &
  AVF vs.\ tunnelled catheter: $-$26\% mortality risk in the DOPPS international cohort; access type is the strongest modifiable predictor &
  \cite{pisoni2002vascular} \\[4pt]

\texttt{couverture\_medicale} & SHAP \#2 &
  Patients without social coverage have delayed or suboptimal dialysis access in Morocco; health coverage is an independent survival determinant in low-to-middle-income countries &
  \cite{maoujoud2017morocco, usrds2022} \\[4pt]

\texttt{calcium\_basale} & SHAP \#3 &
  Both hypercalcaemia and hypocalcaemia independently predict 1-year mortality across DOPPS sites; mineral metabolism disorders are a leading cause of cardiovascular death in HD &
  \cite{tentori2008, kdigo_mineral_2017} \\[4pt]

\texttt{albumine\_basale} & SHAP \#4 &
  Each 1~g/dL decrease in serum albumin increases mortality risk; albumin $<$35~g/L is the threshold used in international HD quality registries &
  \cite{albumin_dialysis_2018} \\[4pt]

\texttt{evenement\_cardiovasculaire} & SHAP top-24 &
  Prior cardiovascular events (MI, stroke, cardiac arrest) are the strongest predictor of death in HD; cardiovascular disease accounts for $>$40\% of mortality &
  \cite{foley1998cv, registre_rein_2022} \\[4pt]

\texttt{admission\_cathetere\allowbreak\_tunnellise} & SHAP top-24 &
  Tunnelled catheter at dialysis initiation is associated with 2--3$\times$ higher bloodstream infection risk and excess early mortality compared to AVF &
  \cite{pisoni2002vascular} \\[4pt]
...
\texttt{nombre\_hospitalisations} & SHAP top-24 &
  Hospitalisation count integrates global morbidity burden; confirmed as a strong mortality predictor in ML-based HD models on 5,351 patients &
  \cite{sheng2020, beddhu2000charlson} \\[4pt]

\texttt{pth\_basale} & SHAP top-24 &
  PTH $>$600~pg/mL associated with elevated all-cause and cardiovascular mortality in the DOPPS cohort; secondary hyperparathyroidism is a KDIGO-MBD treatment target &
  \cite{tentori2008, kdigo_mineral_2017} \\[4pt]

\texttt{ferritine\_basale} & SHAP top-24 &
  Time-dependent cohort study: both very low and very high ferritin independently predict mortality in HD patients; J-shaped relationship confirmed in JASN cohort analysis &
  \cite{kalantar2005iron} \\[4pt]
...
\texttt{etiologie\_mrc} & SHAP top-24 &
  USRDS and REIN registries stratify 1-year survival by CKD aetiology; diabetic nephropathy shows higher early mortality than glomerulonephritis or hereditary causes &
  \cite{usrds2022, registre_rein_2022} \\[4pt]
...
\texttt{hypertension} & Lit. &
  HTA present in $>$80\% of HD patients; uncontrolled blood pressure is a direct cardiovascular mortality driver; included in the Charlson Comorbidity Index &
  \cite{foley1998cv, beddhu2000charlson, registre_rein_2022} \\[4pt]

\texttt{cardiopathie} & Lit. &
  Cardiac disease causes $>$40\% of HD deaths; myocardial infarction and cardiac failure are the leading causes; necessary for complete risk phenotyping &
  \cite{foley1998cv, beddhu2000charlson} \\[4pt]

\texttt{diabete} & Lit. &
  Diabetic nephropathy is the first cause of ESRD worldwide; diabetes amplifies cardiovascular, infectious, and vascular access complications in HD patients &
  \cite{registre_rein_2022, usrds2022} \\[4pt]
...
\texttt{maladie\_renale\_hereditaire} & Lit. &
  ERA-EDTA registry: ADPKD patients on dialysis have significantly better 1-year survival than diabetic/hypertensive ESRD patients; hereditary nephropathy acts as a protective factor in mortality models &
  \cite{spithoven2014, usrds2022} \\[4pt]
...
\texttt{hemodialyse} & Lit. &
  ...
  \cite{weinhandl2010, kdigo2015} \\[4pt]
...
\texttt{information\_transplantation\allowbreak\_donnee} & Lit. &
  Transplant education is associated with higher waitlisting rates and reduced mortality; access to information is unequal in the Moroccan context &
  \cite{maoujoud2017morocco, usrds2022} \\[4pt]
